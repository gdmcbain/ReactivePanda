...
def firefighter(**a):
    return pandaModel(
        "firefighter/firefighter-base.egg",
        name="firefighter",
...
def ralph(**a):
    return pandaModel(
        PandaGlobals.pandaPath / "models" / "Ralph" / "ralph.egg",
        name="Ralph",
        ...
        animation={
            "walk": PandaGlobals.pandaPath / "/models/Ralph/ralph-walk.egg",
            "run": PandaGlobals.pandaPath / "/models/Ralph/ralph-run.egg",
            "jump": PandaGlobals.pandaPath / "/models/Ralph/ralph-jump.egg",
            "offbalance": PandaGlobals.pandaPath / "/models/Ralph/ralph-offbalance.egg",
        },
        frame=4,
        **a
    )
...
def russianBuilding(**a):
    return pandaModel(
        "russianBuilding/tetris-building.egg", name="RussianBuilding", **a
    )
...
def flower(**a):
    return pandaModel(
        "Flower/flower#3",
        name="Flower",
        texture=Globals.pandaPath + "/models/Flower/flowerPurple.png",
        **a
    )
...
def spiderman(**a):
    return pandaModel(
        PandaGlobals.pandaPath + "/models/Spiderman/SpiderMan.egg",
        name="Spiderman",
        animation={
            "DOIT!": PandaGlobals.pandaPath + "/models/Spiderman/SpiderMan-DOIT.egg",
            "pose": PandaGlobals.pandaPath + "/models/Spiderman/SpiderMan-Pose.egg",
        },
...
def sonic(**a):  # Works as of 6-23-08 ~ Kendric
    return pandaModel(
        ...
        joints=[
            ...
            ("leftLowerSpike", "LeftLowerSpike"),
            ("lowerRightSpike", "LowerRightSpike"),
            ("topSpike", "TopSpike"),
            ("leftMiddleSpike", "LeftMiddleSpike"),
            ("rightMiddleSpike", "RightMiddleSpike"),
            ("lowerSpike", "LowerSpike"),
            ("jaw", "Jaw"),
            ("leftShoulder", "LeftShoulder"),
            ("rightShoulder", "LeftShoulder1"),
            ("leftElbow", "LeftElbow"),
            ("rightElbow", "LeftElbow1"),
            ("leftWrist", "LeftWrist"),
            ("rightWrist", "LeftWrist1"),
            ("leftHip", "LeftHip"),
            ("rightHip", "RightHip"),
            ("leftKnee", "LeftKnee"),
            ("rightKnee", "RightKnee"),
        ...
        animation={"walk": Globals.pandaPath + "/models/sonic/sonic-run.egg"},
        frame=11,
        **a
    )
